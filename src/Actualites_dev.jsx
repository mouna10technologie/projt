...
function CarteActualite({ titre, description, image, categorie, date, auteur, lienLecture }) {
    ...
    <div className="carte-actualite">
      <div className="carte-actualite-header">
        ...
        <div className="badge-categorie">
          <span className={`badge-cat ${categorie.toLowerCase().replace(/\s+/g, '-')}`}>
            {categorie}
          </span>
        </div>
      </div>
  ...
  const actualitesRecentes = [
    {
      ...
      description: "Découvrez les Server Components, les nouvelles APIs de concurrence et les améliorations de performance qui transforment le développement React.",
    ...
    },
    {
      ...
      description: "OpenAI annonce des avancées majeures en IA multimodale. Impact sur le développement, l'automatisation du code et les outils de productivité.",
    ...
    },
    {
      ...
      description: "Analyse de l'adoption croissante de Rust dans les projets critiques. Performance, sécurité mémoire et écosystème en pleine expansion.",
      image: "./public/Developeurs.png",
      categorie: "Langages",
      date: "10 Déc 2024",
      auteur: "Marcus Weber",
    ...
    },
    {
      ...
      description: "Les nouvelles spécifications WASM révolutionnent le web. Applications desktop-class, gaming et calcul scientifique directement en ligne.",
      image: "./public/DevloppeurX.jpeg",
    ...
    },
    {
      ...
      description: "Retour d'expérience sur les dernières capacités de Copilot. Génération de tests, debugging automatique et pair programming avec l'IA.",
      image: "./public/Developeurs.png",
      categorie: "Intelligence Artificielle",
      date: "5 Déc 2024",
      auteur: "Thomas Liu",
    ...
    },
    {
      ...
      description: "Les nouvelles fonctionnalités de TypeScript améliorent drastiquement l'expérience développeur. Pattern matching et types conditionnels avancés.",
      image: "./public/DevloppeurX.jpeg",
      categorie: "Langages",
      date: "3 Déc 2024",
      auteur: "Jessica Park",
    ...
    },
    {
      ...
      description: "Comment l'edge computing transforme les applications web. Latence ultra-faible, traitement local et nouvelles architectures distribuées.",
      image: "./public/Developeurs.png",
      categorie: "Nouvelles Technologies",
      date: "1 Déc 2024",
      auteur: "David Kim",
    ...
    },
    {
      ...
      description: "Étude complète sur l'évolution des salaires dans la tech. Remote work, spécialisations les plus demandées et négociation salariale.",
      image: "./public/DevloppeurX.jpeg",
      categorie: "Développeurs",
      date: "28 Nov 2024",
      auteur: "Marie Dubois",
    ...
    },
    {
      ...
      description: "IBM et Google annoncent des percées en informatique quantique. Applications concrètes pour la cryptographie et l'optimisation.",
      image: "./public/Developeurs.png",
      categorie: "Nouvelles Technologies",
      date: "25 Nov 2024",
    ...
    <>
      ...
      <div className="section-actualites-recentes">
        <div className="actualites-header">
          <h2 className="titre-actualites-recentes">
            {"🚀 Actualités Développement & Tech".split('').map((char, index) => (
              <span key={index} className="lettre-animee-actualites" style={{animationDelay: `${index * 0.04}s`}}>
                {char === ' ' ? '\u00A0' : char}
              </span>
            ))}
          </h2>
          <p className="sous-titre-actualites">Restez à jour avec les dernières innovations technologiques</p>
        </div>
      ...
      <div className="div_actuel">
        <h2 className="titre-outils-actualites">
          {"Les outils et ressources que les développeurs utilisent pour rester à jour".split('').map((char, index) => (
            <span key={index} className="lettre-animee-outils-actu" style={{animationDelay: `${index * 0.025}s`}}>
              {char === ' ' ? '\u00A0' : char}
            </span>
          ))}
        </h2>
