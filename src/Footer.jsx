      ...
      <div className="footer-container">
        ...
        <div className="footer-section logo-section">
          ...
          <p className="footer-description">
            Votre plateforme de référence pour connecter les talents du
            développement avec les meilleures opportunités professionnelles au
        ...
        <div className="footer-section nav-section">
          ...
          <ul className="footer-links">
            ...
            <li>
              <Link to="/Developpeurs" className="footer-link">
                👨‍💻 Développeurs
              </Link>
            </li>
            <li>
              <Link to="/Recruteurs" className="footer-link">
                🏢 Recruteurs
              </Link>
            </li>
            <li>
              <Link to="/Actualites_dev" className="footer-link">
                📰 Actualités Dev
              </Link>
            </li>
            <li>
              <Link to="/IA" className="footer-link">
          ...
          <div className="contact-info">
            <div className="contact-item">
              ...
              <div className="contact-details">
                ...
                <a href="tel:+212679013459" className="contact-value">
                  +212 6 79 01 34 59
                </a>
              </div>
            </div>
            <div className="contact-item">
              ...
              <div className="contact-details">
                ...
                <a href="mailto:Dev_job@gmail.com" className="contact-value">
                  Dev_job@gmail.com
                </a>
              </div>
            </div>
